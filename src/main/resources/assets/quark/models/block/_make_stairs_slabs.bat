...
for %%x in (%*) do (
	...
	(
		...
		echo 	}
		echo }
	) > ../../blockstates/%%x_slab_double.json
	...
	(
		...
		echo     "facing=east,half=top,shape=outer_right":  { "model": "minecraft:outer_stairs", "x": 180, "uvlock": true },
		echo     "facing=west,half=top,shape=outer_right":  { "model": "minecraft:outer_stairs", "x": 180, "y": 180, "uvlock": true },
		echo     "facing=south,half=top,shape=outer_right": { "model": "minecraft:outer_stairs", "x": 180, "y": 90, "uvlock": true },
		echo     "facing=north,half=top,shape=outer_right": { "model": "minecraft:outer_stairs", "x": 180, "y": 270, "uvlock": true },
		echo     "facing=east,half=top,shape=outer_left":  { "model": "minecraft:outer_stairs", "x": 180, "y": 90, "uvlock": true },
		echo     "facing=west,half=top,shape=outer_left":  { "model": "minecraft:outer_stairs", "x": 180, "y": 270, "uvlock": true },
		echo     "facing=south,half=top,shape=outer_left": { "model": "minecraft:outer_stairs", "x": 180, "y": 180, "uvlock": true },
		echo     "facing=north,half=top,shape=outer_left": { "model": "minecraft:outer_stairs", "x": 180, "uvlock": true },
		echo     "facing=east,half=top,shape=inner_right":  { "model": "minecraft:inner_stairs", "x": 180, "uvlock": true },
		echo     "facing=west,half=top,shape=inner_right":  { "model": "minecraft:inner_stairs", "x": 180, "y": 180, "uvlock": true },
		echo     "facing=south,half=top,shape=inner_right": { "model": "minecraft:inner_stairs", "x": 180, "y": 90, "uvlock": true },
		echo     "facing=north,half=top,shape=inner_right": { "model": "minecraft:inner_stairs", "x": 180, "y": 270, "uvlock": true },
